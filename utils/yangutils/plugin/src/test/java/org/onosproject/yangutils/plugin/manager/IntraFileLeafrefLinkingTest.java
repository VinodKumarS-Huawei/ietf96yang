...
public class IntraFileLeafrefLinkingTest {
    ...
    public void processPathArgumentStatement()
        ...
        List<YangAbsolutePath> absPathForName = relativePathForName.getAbsolutePath();
        Iterator<YangAbsolutePath> absPathIteratorForName = absPathForName.listIterator();
        YangAbsolutePath abspathForName = absPathIteratorForName.next();
        ...
        YangAbsolutePath abspath1 = absPathIteratorForName.next();
        ...
        List<YangAbsolutePath> absolutePathList = leafref1.getAbsolutePath();
        Iterator<YangAbsolutePath> absPathIterator = absolutePathList.listIterator();
        YangAbsolutePath abspath = absPathIterator.next();
        ...
        assertThat(pathPredicate1.getRightRelativePath().getAbsolutePath().listIterator().next().getNodeIdentifier()
                .getName(), is("ifname"));
        YangAbsolutePath abspath2 = absPathIterator.next();
